                ...
                <li>
                    <div class="slider-img">
                        <div class="slider_banner_info">
                            <h4>
                                <span>Bus SÀI GÒN</span><br/>An Toàn-Lịch Sự-Văn Minh
                                <span>trên mọi tuyến đường</span>
                            </h4>
...
<div class="welcome" id="about">
    <div class="container">
        ...
        <div class="col-md-6 welcome-left">
            <h3>Khôi phục lộ trình 13 tuyến buýt Sài Gòn</h3>
            <h4>Lộ trình di chuyển của 10 tuyến buýt tại khu vực An Sương và 3 tuyến buýt tại quận Tân Phú, TP.HCM, đã
                được khôi phục, sau thời gian chịu ảnh hưởng từ các công trình thi công.</h4>
            <p>Trước đó, do rào chắn của công trình xây dựng nhánh N1 hầm chui An Sương, dẫn đến lộ trình các tuyến xe
                buýt tại khu vực An Sương bị thay đổi. Hiện tại, nhánh N1 hầm chui An Sương đã được thông xe nên Trung
                tâm Quản lý Giao thông công cộng cho khôi phục lộ trình của 10 tuyến xe buýt qua khu vực này.</p>
            <div class="readmore-w3-agileits about-read">
                <a href="#" data-toggle="modal" data-target="#myModal1">Đọc thêm</a>
            </div>
        </div>
...
<div class="middle-w3l">
    <div class="container">
        <div class="middle-left-w3l">
            <h4>Trung tâm Quản lý giao thông công cộng Thành phố Hồ Chí Minh</h4>
            <p>27 Phạm Viết Chánh, Phường Nguyễn Cư Trinh, Quận 1, Thành phố Hồ Chí Minh</p>
            <div class="readmore-w3-agileits about-read">
                <a href="contact.html">Liên hệ</a>
            </div>
        </div>
...
<div class="trips-section">
    <div class="container">
        <h3 class="title">Vòng quanh Sài Gòn</h3>
        <div class="col-xs-4 exce-grid1-mmstyle">
            <img src="images/k1.jpg" alt="">
            <div class="grid-ec1">
                <h3>Bitexco Financial</h3>
                <p>Tòa nhà Bitexco Financial, Bitexco Financial Tower hay Tháp Tài chính Bitexco là một tòa nhà chọc
                    trời...</p>
                <h4>
                    <i class="fa fa-map-marker"></i>02 Hải Triều, Quận 1, Thành phố Hồ Chí Minh</h4>
            </div>
        </div>
        <div class="col-xs-4 exce-grid1-mmstyle">
            ...
            <div class="grid-ec1">
                <h3>Chợ Bến Thành</h3>
                <p>Chợ Bến Thành là một ngôi chợ nằm tại Quận 1, Thành phố Hồ Chí Minh. Trong nhiều trường hợp, hình
                    ảnh...</p>
                <h4>
                    <i class="fa fa-map-marker"></i>Lê Lợi, Phường Bến Thành, Quận 1, Hồ Chí Minh</h4>
            </div>
        </div>
        <div class="col-xs-4 exce-grid1-mmstyle">
            ...
            <div class="grid-ec1">
                ...
                <p>Đường Nguyễn Huệ là một đường phố trung tâm tại Quận 1, Thành phố Hồ Chí Minh, nối liền Trụ sở...</p>
                <h4>
                    <i class="fa fa-map-marker"></i>Nguyễn Huệ, Bến Nghé, Quận 1, Hồ Chí Minh</h4>
            </div>
        </div>
        <div class="clearfix"></div>
    </div>
